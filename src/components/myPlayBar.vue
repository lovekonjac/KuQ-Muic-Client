  ...
  <div class="play-bar" :class="{show:!toggle}">
    ...
    <div class="kongjian">
      ...
      <div class="item" @click="togglePlay">
        <!-- 根据播放状态动态切换图标 -->
        <i :class="{'fas fa-play': !isPlay, 'fas fa-pause': isPlay}"></i>
      </div>
      <!--下一首-->
      ...
      <div class="item icon-volume" >
        <!-- 根据音量动态切换图标 -->
        <i :class="{'fas fa-volume-up': volume !== 0, 'fas fa-volume-mute': volume === 0}"></i>
        <el-slider class="volume" v-model="volume" :vertical="true"></el-slider>
      </div>
      <!--添加-->
      <div class="item" @click="collection">
        <!-- 根据是否激活动态切换图标 -->
        <i :class="{'fas fa-heart': isActive, 'far fa-heart': !isActive}"></i>
      </div>
      <!--下载-->
